...
<style>
    ...
    .form-group label { display:block; font-size:0.78rem; font-weight:700; letter-spacing:0.07em; text-transform:uppercase; color:var(--text-dark); margin-bottom:0.35rem; }
    .form-control { width:100%; padding:0.65rem 1rem; border:1.5px solid #d8cce0; border-radius:6px; font-family:'Inter',sans-serif; font-size:0.875rem; color:var(--text-dark); background:#fff; outline:none; transition:border-color 0.2s,box-shadow 0.2s; box-sizing: border-box; }
    ...
    .invalid-feedback { color:#d95f5f; font-size:0.75rem; margin-top:0.2rem; display:block; }
    ...
    .btn-register {
        width:100%; padding:0.8rem; background:var(--violet-night); color:var(--snow);
        border:none; border-radius:6px; font-family:'Inter',sans-serif; font-size:0.95rem;
        font-weight:600; cursor:pointer; transition:background 0.2s,transform 0.15s; margin-top:0.4rem; letter-spacing:0.02em;
    }
    .btn-register:hover { background:var(--violet-mid); transform:translateY(-1px); }

    .auth-alt-link { text-align:center; font-size:0.85rem; color:var(--text-light); margin-top:1rem; }
    .auth-alt-link a { color:var(--violet-night); font-weight:700; text-decoration:none; }
        ...
        <form action="{{ route('register') }}" method="POST" novalidate>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="firstName" id="firstName" class="form-control @error('firstName') is-invalid @enderror"
                        value="{{ old('firstName') }}" placeholder="Jane" required>
            ...
            <div class="form-group">
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" class="btn-eye" data-field="passwordConfirmation" data-icon="eyeIcon-confirm">
                        <svg id="eyeIcon-confirm" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                            <circle cx="12" cy="12" r="3"/>
